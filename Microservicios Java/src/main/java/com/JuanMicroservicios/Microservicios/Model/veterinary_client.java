...
public class veterinary_client {
    ...
    public veterinary_client(Integer id, String name, String last_name, String email, String phone, Integer veterinary_id, String document, String global_id) {
        this.id = id;
        this.name = name;
    ...
    public void setVerinary_id(Integer verinary_id) {
        this.veterinary_id = verinary_id;
    }
